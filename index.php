        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <ul class="list-inline banner-social-buttons">
                    <li>
                        <p>Jake Sylvestre</p><p>Backend Developer</p>
                        <a href="https://github.com/jakesyl" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                    </li>
                    <li>
                        <p>Alex Parson</p><p>Backend Developer</p>
                        <a href="https://github.com/aep000" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>Rob Brinker</p><p>Design &amp; Networking</p>
                        <a href="https://github.com/Brinker1999" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                    </li>
                </ul>
            </div>
        </div>
